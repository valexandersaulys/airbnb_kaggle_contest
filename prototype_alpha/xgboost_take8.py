...
param['nthread'] = 5
param['min_child_weight'] = 1  # 1 is the default; the larger, the more conservative
...
df.to_csv("xgboost_take8.csv",index=False)

# Save model
clf.save_model('xgb_take8.model');
